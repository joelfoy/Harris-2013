...
class CustomFields {
   ...
   public function selectContentType() {
    ...
    public function ajax_update_admin() {
        ...
        $this->fields_info['types'][$type]['public']=($_POST['public']=='checked' || $_POST['public']=='true')?true:false;
        $this->fields_info['types'][$type]['show_ui']=($_POST['show_ui']=='checked' || $_POST['show_ui']=='true')?true:false;
    ...
    public function ajax_update_visibility() {
        ...
        $this->fields_info['types'][$type]['query_var']=($_POST['query_var']=='checked' || $_POST['query_var']=='true')?true:false;
        $this->fields_info['types'][$type]['exclude_from_search']=($_POST['exclude_from_search']=='checked' || $_POST['exclude_from_search']=='true')?false:true;
...
function the_ept_field($name, $options=null) {
    global $post;
    if (!isset($post->ct_theme)) $post->ct_theme=get_easy_post_type();
